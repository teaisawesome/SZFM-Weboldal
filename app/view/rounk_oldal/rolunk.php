...
<head>
    ...
    <link rel="stylesheet" href="assets/css/rolunk_oldal/rolunk.css">
...
<body>
    ...
    <main>
        <div class="szovegresz">
            <div class="kor kor1">
                <img src="resources/images/rolunk_oldal_images/rolunkbal1.jpg" alt="">
            </div>
            <div class="kor kor2">
                <img src="resources/images/rolunk_oldal_images/rolunkjobb1.jpg" alt="">
            </div>
            <div class="tartalom">
            ...
            <div class="kor kor1">
                <img src="resources/images/rolunk_oldal_images/rolunkjobb2.jpg" alt="">
            </div>
            <div class="kor kor2">
                <img src="resources/images/rolunk_oldal_images/rolunkbal2.jpg" alt="">
            </div>
            <div class="tartalom">
                <h2>Nos si nos esse salubrius instituendi</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam odio possimus ipsa officia, est mollitia sapiente quia cupiditate sequi magni. Exercitationem minus, dolor doloremque aspernatur veritatis vel atque eligendi modi. Lorem ipsum
    ...
    <footer>
        ...
        <section class="about-container">
            <div class="about">
                <p class="rolunk">Fedezze fel a szolgáltatásainkat!</p>
