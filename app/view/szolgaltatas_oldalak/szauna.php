...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/szolgaltatas_oldalak/szauna.css">
...
<body>
    ...
    <main>
        <div class="szovegresz">
            <div class="kor kor1">
                <img src="../resources/images/szolgaltatas_oldalak_images/szaunakomplex.jpg" alt="">
            </div>
            <div class="kor kor2">
                <img src="../resources/images/szolgaltatas_oldalak_images/szauna2.jpg" alt="">
            </div>
            <div class="tartalom">
                <h2>Tua nobis salutem sit amet</h2>
        ...
        <div class="page-wrapper">
            <div class="post-slider">
                ...
                <div class="post-wrapper">
                    ...
                    <div class="post">
                        <img src="../resources/images/szolgaltatas_oldalak_images/szauna2.jpg" alt="" class="slider-image">
                    </div>
                    <div class="post">
                        <img src="../resources/images/szolgaltatas_oldalak_images/szauna2.jpg" alt="" class="slider-image">
    ...
    <script src="../assets/js/szolgaltatas_oldalak_js/szauna.js"></script>
</body>