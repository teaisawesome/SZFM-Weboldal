...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/szolgaltatas_oldalak/sobarlang.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css" integrity="sha512-+4zCK9k+qNFUR5X+cKL9EIR+ZOhtIloNl9GIKS57V1MyNsYpYcUrUeQc9vNfzsWfV28IaLL3i96P9sdNyeRssA==" crossorigin="anonymous" />
    <title>Sobarlang</title>
</head>
...
<body>
    ...
    <main>
        <div class="szovegresz">
            <div class="kor kor1">
                <img src="../resources/images/szolgaltatas_oldalak_images/sobal.jpg" alt="">
            </div>
            <div class="kor kor2">
                <img src="../resources/images/szolgaltatas_oldalak_images/sojobb.jpg" alt="">
            </div>
            <div class="tartalom">
                <h2>De naribus umiferum duxere salis</h2>
        ...
        <div class="page-wrapper">
            <div class="post-slider">
                ...
                <div class="post-wrapper">
                    ...
                    <div class="post">
                        <img src="../resources/images/szolgaltatas_oldalak_images/soslide.jpg" alt="" class="slider-image">
                    </div>
                    <div class="post">
                        <img src="../resources/images/szolgaltatas_oldalak_images/soslide.jpg" alt="" class="slider-image">
    ...
    <script src="../assets/js/szolgaltatas_oldalak_js/sobarlang.js"></script>
</body>